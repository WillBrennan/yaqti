...
@click.option('--set-env', type=bool, default=True)
@click.option('--install-deps', type=bool, default=True)
def install(os: str, platform: str, version: str, output: str, modules: List[str], set_env: bool, install_deps: bool):
